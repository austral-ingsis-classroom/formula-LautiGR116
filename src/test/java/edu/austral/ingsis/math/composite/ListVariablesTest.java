...
public class ListVariablesTest {
  ...
  public void shouldListVariablesFunction1() {
    final Collection<String> result = new Sum(new Value(1), new Value(6)).getVariables();
  ...
  public void shouldListVariablesFunction4() {
    final Collection<String> result =
        new Power(new Division(new Value(27), new Variable("a")), new Variable("b")).getVariables();
  ...
  public void shouldListVariablesFunction5() {
    final Collection<String> result =
        new Power(new Variable("z"), new Division(new Value(1), new Value(2))).getVariables();
