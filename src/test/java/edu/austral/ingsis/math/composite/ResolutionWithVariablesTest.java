...
public class ResolutionWithVariablesTest {
  ...
  public void shouldResolveFunction1() {
    final Double result =
        new Sum(new Value(1), new Variable("x")).compute(Map.of("x", new Value(3)));
  ...
  public void shouldResolveFunction2() {
    final Double result =
        new Division(new Value(12), new Variable("div")).compute(Map.of("div", new Value(4)));
  ...
  public void shouldResolveFunction3() {
    final Double result =
        new Multiplication(new Division(new Value(9), new Variable("x")), new Variable("y"))
            .compute(Map.of("x", new Value(3), "y", new Value(4)));
  ...
  public void shouldResolveFunction4() {
    final Double result =
        new Power(new Division(new Value(27), new Variable("a")), new Variable("b"))
            .compute(Map.of("a", new Value(9), "b", new Value(3)));
