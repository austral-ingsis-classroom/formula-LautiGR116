...
public class ResolutionTest {
  ...
  public void shouldResolveSimpleFunction1() {
    Function function = new Sum(new Value(1), new Value(6));
    final Double result = computationVisitor.compute(function);
  ...
  public void shouldResolveSimpleFunction6() {
    Function function = new Modulus(new Value(136));
    final Double result = computationVisitor.compute(function);
  ...
  public void shouldResolveSimpleFunction7() {
    Function function = new Modulus(new Negation(new Value(136)));
    final Double result = computationVisitor.compute(function);
