...
public class ResolutionWithVariablesTest {
  ...
  public void shouldResolveFunction1() {
    ComputationVisitor testComputationVisitor =
        computationVisitor.setVariables(Map.of("x", new Value(3)));
  ...
  public void shouldResolveFunction2() {
    ComputationVisitor testComputationVisitor =
        computationVisitor.setVariables(Map.of("div", new Value(4)));
  ...
  public void shouldResolveFunction3() {
    ComputationVisitor testComputationVisitor =
        computationVisitor.setVariables(Map.of("x", new Value(3), "y", new Value(4)));
    Function function =
  ...
  public void shouldResolveFunction4() {
    ComputationVisitor testComputationVisitor =
        computationVisitor.setVariables(Map.of("a", new Value(9), "b", new Value(3)));
    Function function =
  ...
  public void shouldResolveFunction5() {
    ComputationVisitor testComputationVisitor =
        computationVisitor.setVariables(Map.of("z", new Value(36)));
  ...
  public void shouldResolveFunction6() {
    ComputationVisitor testComputationVisitor =
        computationVisitor.setVariables(Map.of("value", new Value(8)));
  ...
  public void shouldResolveFunction8() {
    ComputationVisitor testComputationVisitor =
        computationVisitor.setVariables(Map.of("i", new Value(2)));
    Function function =
